...
object KeyPreset {
    ...
    val lx17PYKeyPreset: Map<Int, Array<String>> = hashMapOf(
        ...
        KeyEvent.KEYCODE_U to arrayOf("U", "；"),
        KeyEvent.KEYCODE_I to arrayOf("I", "（"),
        KeyEvent.KEYCODE_O to arrayOf("OP", "）"),
        KeyEvent.KEYCODE_A to arrayOf("AS", "～"),
        KeyEvent.KEYCODE_D to arrayOf("DF", "“"),
        KeyEvent.KEYCODE_G to arrayOf("G", "”"),
        KeyEvent.KEYCODE_H to arrayOf("H", "："),
        KeyEvent.KEYCODE_J to arrayOf("JK", "@"),
        KeyEvent.KEYCODE_L to arrayOf("L", "."),
        KeyEvent.KEYCODE_Z to arrayOf("ZX", "#"),
        KeyEvent.KEYCODE_C to arrayOf("C", "、"),
        KeyEvent.KEYCODE_V to arrayOf("V", "？"),
        KeyEvent.KEYCODE_B to arrayOf("BN", "！"),
        KeyEvent.KEYCODE_M to arrayOf("M", "……"),
        InputModeSwitcher.USER_KEYCODE_COMMA_EMOJI to arrayOf("，"),
        InputModeSwitcher.USER_KEYCODE_LEFT_COMMA to arrayOf("，", "。"),
        InputModeSwitcher.USER_KEYCODE_LEFT_PERIOD to arrayOf("。", "，"),
    ...
    val lx17PYKeyNumberPreset: Map<Int, Array<String>> = hashMapOf(
        ...
        KeyEvent.KEYCODE_U to arrayOf("U", "2"),
        KeyEvent.KEYCODE_I to arrayOf("I", "3"),
        KeyEvent.KEYCODE_O to arrayOf("OP", "？"),
        KeyEvent.KEYCODE_A to arrayOf("AS", "/"),
        KeyEvent.KEYCODE_D to arrayOf("DF", "～"),
        KeyEvent.KEYCODE_G to arrayOf("G", "4"),
        KeyEvent.KEYCODE_H to arrayOf("H", "5"),
        KeyEvent.KEYCODE_J to arrayOf("JK", "6"),
        KeyEvent.KEYCODE_L to arrayOf("L", "！"),
        KeyEvent.KEYCODE_Z to arrayOf("ZX", "……"),
        KeyEvent.KEYCODE_C to arrayOf("C", "、"),
        KeyEvent.KEYCODE_V to arrayOf("V", "7"),
        KeyEvent.KEYCODE_B to arrayOf("BN", "8"),
        KeyEvent.KEYCODE_M to arrayOf("M", "9"),
        InputModeSwitcher.USER_KEYCODE_COMMA_EMOJI to arrayOf("，"),
        InputModeSwitcher.USER_KEYCODE_LEFT_COMMA to arrayOf("，", "。"),
        InputModeSwitcher.USER_KEYCODE_LEFT_PERIOD to arrayOf("。", "，"),
