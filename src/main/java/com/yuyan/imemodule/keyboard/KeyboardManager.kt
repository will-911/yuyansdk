...
class KeyboardManager {
    enum class KeyboardType {
        T9, QWERTY, LX17, ZX17, QWERTYABC, NUMBER, SYMBOL, SETTINGS, HANDWRITING, CANDIDATES, ClipBoard, TEXTEDIT
    }
    ...
    fun switchKeyboard(keyboardName: KeyboardType) {
        ...
        if (container == null) {
            container = when (keyboardName) {
                ...
                KeyboardType.ZX17 -> T9TextContainer(Launcher.instance.context, mInputView, InputModeSwitcher.MASK_SKB_LAYOUT_ZX17)
